...
@objcMembers final public class ARSLineProgressConfiguration: NSObject {
    ...
    public static var backgroundViewStyle: BackgroundStyle = .full
	...
	public static var blurStyle: UIBlurEffect.Style = .extraLight
    public static var circleColorOuter: CGColor = UIColor.ars_colorWithRGB(60.0, green: 132.0, blue: 196.0, alpha: 1.0).cgColor
	public static var circleColorMiddle: CGColor = UIColor.ars_colorWithRGB(60.0, green: 132.0, blue: 196.0, alpha: 1.0).cgColor
